...
import {
  ...
  ɵfirebaseAppFactory,
  ɵlazySDKProxy
} from "./chunk-NYTSZTPG.js";
import {
  firebase
} from "./chunk-FRZURM2E.js";
import {
  FirebaseApp
} from "./chunk-E54NIO75.js";
import {
  VERSION,
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name2, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-42C36ZZU.js"))), map(() => ɵfirebaseAppFactory(options, zone, name2)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
...
@firebase/app-check/dist/esm/index.esm2017.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-UYIAZIAF.js.map
